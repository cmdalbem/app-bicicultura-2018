        ...
        <div className={classes.root}>
          ...
          <AppBar position="static"> 
            <Toolbar> 
              ...
              { this.showPWAButton &&
                <Tooltip title="Como instalar o app">
          ...
          >
            ...
            <Paper className={classes.root + ' bottom-navbar'}>
                <BottomNavigation
                    value={this.state.currentNav}
                    onChange={this.handleNavChange}
                    // showLabels
                >
                    <BottomNavigationAction label="Programação" icon={<DateRangeIcon />} />
          ...
          {this.state.currentNav === 1 &&
            <div>
                ...
                {/* <p>
                    O Bicicultura – Encontro Brasileiro de Mobilidade por Bicicleta e Cicloativismo – é um encontro anual, 
                    organizado pela sociedade civil, para celebrar e promover a cultura da bicicleta como meio de 
                    transporte nas cidades  brasileiras. Trata-se, antes de mais nada, de um espaço para o convívio, 
                    compartilhamento de conhecimento e formação de alianças entre ciclistas, cicloativistas, entusiastas 
                    e interessados e tem como objetivo promover o uso da bicicleta em todas as suas vertentes: cultural, 
                    social, política, artística, econômica e ambiental.
                </p>

                <p>
                    O Bicicultura é uma realização da União de Ciclistas do Brasil (UCB) e, a cada edição, conta com o 
                    apoio de instituições e coletivos locais para a sua produção. Em 2018, o Bicicultura acontecerá no Rio
                    de Janeiro, entre os dias 08 e 10 de Junho.
                </p> */}
                ...
                <List>
                    ...
                    >
                        <ListItemIcon>
                            ...
                            <ListItemText primary="Site oficial do evento" secondary="http://bicicultura.rio"/>
                    </ListItem>
                    <ListItem
                        button
                        component="a"
                    ...
                    >
                        <ListItemIcon>
                            ...
                            <ListItemText primary="Contato" secondary="contato@bicicultura.rio"/>
                    </ListItem>
                </List>
            </div>
          }
